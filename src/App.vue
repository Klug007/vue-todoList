...
const removeTodo = (id) => {
  todos.value = todos.value.filter((todo) => todo.createdAt != id)
}
  ...
  <main class="app">
    ...
    <section class="create-todo">
      ...
      <form @submit.prevent="addTodo">
        ...
        <input required type="text" placeholder="e.g. make a video" v-model="input_content" />
      ...
      <div class="list">
        ...
        >
          <label>
            ...
            <span :class="todo.category" class="bubble"></span>
          </label>
